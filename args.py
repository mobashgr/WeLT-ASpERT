...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--model_type', type=str, default="aspert", help="Type of model")
    ...
    arg_parser.add_argument('--prop_drop', type=float, default=0.1, help="Probability of dropout used in ASpERT")
